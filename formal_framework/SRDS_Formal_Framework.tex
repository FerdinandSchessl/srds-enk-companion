...
The hypothesis $q_0''(1/2)<0$ (equivalently $(Q^*)'''(1/2)\neq0$) is a named condition, not implied by a strict maximum alone: a strict maximum permits a flat (degenerate) inflection. Under it the linearized inflection condition has nonzero leading coefficient and $d\tau/d\alpha|_0=-\dot Q(1/2)/(Q^*)'''(1/2)$ is well defined.
\end{remark}
