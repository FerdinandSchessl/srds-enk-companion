...
The order-parameter sigmoid (Q vs normalized load Σ) gives â=0.325, k=2.86 (writeup
`SRDS_Section4-5_Biopolymer_Textbaustein.docx`; re-fit needs scipy on the binned Q–Σ curve).
