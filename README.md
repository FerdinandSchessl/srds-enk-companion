...
Dieser Ordner enthält alle Reproduktions-Artefakte, die das Concise-Paper allein abdecken (Lean-4 Beweise, Roh/Fit-Daten der zehn Substrate, Pipeline-Skripte, Genealogie). Der Ordner ist so strukturiert, dass ein Reviewer ihn isoliert klonen, navigieren **und nachrechnen** kann.
...
| 4 | Lignin/LCC (SP-LCC, Alopaeus 2025) | 72 Bed. | $\rho_S = -0.78$ (β-O-4 vs P-Faktor); $\tilde{a} = 0.325$ (Weibull, seriell-kaskadiert) | §4.4 |
