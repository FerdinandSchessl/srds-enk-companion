...
Paper: "Self-Referential Dissipative Systems: A Materials Test Across Ten Substrates" (Schessl 2026). <!-- lint:allow: author self-citation (Publikations-Register R4 Zitation-Ausnahme) -->
...
- External source: master's thesis Schessl 2025, Zenodo `10.5281/zenodo.18340365` <!-- lint:allow: author self-citation (Publikations-Register R4 Zitation-Ausnahme) -->
...
- Values (from CSV): $\rho_S(\beta\text{-O-4}, \text{P-factor}) = -0.78$ ($n = 72$; `reproduce.py` [15]); form = Weibull (mode (ii) serial-cascaded), from the aggregation mode, not from AICc. No interior $\hat{a}$: broad β-O-4 strength distribution → concave from the origin ($m<1$), no endurance limit, inflection below the tested severity range (re-anchoring against Schlee 2023 / Mattsson 2017). *(Earlier draft: −0.77/n=90 from a lost text module; the data-backed −0.78/n=72 are authoritative.)*
...
- Values: KS-D $= 0.733$ ($p = 5.7 \cdot 10^{-14}$), $\tilde{a} = 0.646$ (median), $\rho(\hat{a}, \text{EOL}) = +0.18$ n.s. (7/26 reaching EOL, right-censored). *(An earlier NASA-PCoE surrogate $+0.853$ / $0.616$ was synthetic; the real CALB run replaces it.)*
...
- Self-references (all Zenodo DOIs):
  - Schessl 2025 master's thesis: `10.5281/zenodo.18340365` <!-- lint:allow: author self-citation (Publikations-Register R4 Zitation-Ausnahme) -->
  - Schessl 2025 *Emergente Narrative Kontrolle*: `10.5281/zenodo.17556213` <!-- lint:allow: author self-citation (Publikations-Register R4 Zitation-Ausnahme) -->
  - Schessl 2025 *Leben als organisierte Dissipation*: `10.5281/zenodo.17445178` <!-- lint:allow: author self-citation (Publikations-Register R4 Zitation-Ausnahme) -->
  - Schessl 2025 *Self-Reference Axiom*: `10.5281/zenodo.17509367` <!-- lint:allow: author self-citation (Publikations-Register R4 Zitation-Ausnahme) -->
  - Schessl 2026 ENK minimal disclosure: `10.5281/zenodo.18475921` <!-- lint:allow: author self-citation (Publikations-Register R4 Zitation-Ausnahme) -->
  - Schessl 2026 Autocorrelation Blind Spot: `arXiv:2604.14414` <!-- lint:allow: author self-citation (Publikations-Register R4 Zitation-Ausnahme) -->
