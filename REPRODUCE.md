...
`RESULT: all 23 numeric checks PASSED.`
...
| 3 | Multi-material multiaxial fatigue | ã = 0.578; n = 914 (136 metals) | `data/fatigue/multiaxial_fatigue_results.json` | Heng et al. 2024 Sci Data `10.1038/s41597-024-03862-4` |
...
`reproduce.py` recomputes 23 numbers from the bundled data with the standard library.
